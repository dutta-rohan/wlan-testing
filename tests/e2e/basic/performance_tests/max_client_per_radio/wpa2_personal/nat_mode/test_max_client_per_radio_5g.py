...
class TestMaxClientPerradio(object):
    ...
    @pytest.mark.fiveg
    @allure.testcase(name="test_max_client_per_radio_wpa2_nat_fiveg",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-5757")
    def test_max_client_per_radio_wpa2_nat_fiveg(self, get_vif_state, lf_tools,
                                                 create_lanforge_chamberview_dut, lf_test, get_configuration):
        '''
            pytest -m "max_client_per_radio and wpa2_personal and fiveg
        '''
        ...
        wct_obj = lf_test.wifi_capacity(instance_name="test_max_client_per_radio_wpa2_nat_fiveg",
