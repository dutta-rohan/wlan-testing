...
pytestmark = [pytest.mark.regression, pytest.mark.dhcp, pytest.mark.verify_classA_ip, pytest.mark.wpa2_personal,
              pytest.mark.nat,
              pytest.mark.fiveg]
...
setup_params_general = {
    ...
    "rf": {},
    "ipv4": {"addressing": "static", "subnet": "112.116.10.14/8",
    ...
    def test_classA_ip_fiveg(self, get_vif_state, lf_tools,
        ...
        if station:
            ...
            if station_ip[0] != config_ip[0]:
                ...
                assert False,"station didn't got ip as per ClassA subnet"
            else:
