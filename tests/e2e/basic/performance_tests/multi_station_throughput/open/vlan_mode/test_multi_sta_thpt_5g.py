"""
    ...
    pytest -m "Multi_Sta_Thpt and open and vlan and fiveg"
...
pytestmark = [pytest.mark.performance,pytest.mark.Multi_Sta_Thpt,pytest.mark.open, pytest.mark.vlan,pytest.mark.fiveg]
...
class TestMultiStaThptvlan(object):
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_1",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3632")
    def test_mstathpt_open_vlan_udp_dl_5g_1(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
        ...
        msthpt_obj = lf_test.Multi_Sta_Thpt(mode=mode, ssid_2G=ssid_2G, ssid_5G=ssid_5G,
                                          instance_name="multistathpt_instance_open_5g_vlan", raw_line=raw_lines,
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_2",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3634")
    def test_mstathpt_open_vlan_tcp_dl_5g_2(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open  and fiveg"
        ...
        msthpt_obj = lf_test.Multi_Sta_Thpt(mode=mode, ssid_2G=ssid_2G, ssid_5G=ssid_5G,
                                            instance_name="multistathpt_instance_open_5g_vlan",
                                            raw_line=raw_lines,
                                            vlan_id=vlan, dut_5g=dut_5g, dut_2g=dut_2g)
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_3",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3636")
    def test_mstathpt_open_vlan_udp_ul_5g_3(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_ul_5g_4",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3638")
    def test_mstathpt_open_vlan_tcp_ul_5g_4(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_5",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3640")
    def test_mstathpt_open_vlan_udp_dl_5g_5(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_6",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3642")
    def test_mstathpt_open_vlan_tcp_dl_5g_6(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_7",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3644")
    def test_mstathpt_open_vlan_udp_ul_5g_7(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_ul_5g_8",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3646")
    def test_mstathpt_open_vlan_tcp_ul_5g_8(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    # @pytest.mark.twog
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_9",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3782")
    def test_mstathpt_open_vlan_udp_dl_5g_9(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and twog  and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_10",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3784")
    def test_mstathpt_open_vlan_tcp_dl_5g_10(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_11",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3787")
    def test_mstathpt_open_vlan_udp_ul_5g_11(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_12",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3789")
    def test_mstathpt_open_vlan_tcp_ul_5g_12(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_13",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3792")
    def test_mstathpt_open_vlan_udp_dl_5g_13(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_14",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3794")
    def test_mstathpt_open_vlan_tcp_dl_5g_14(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_15",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3799")
    def test_mstathpt_open_vlan_udp_ul_5g_15(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_ul_5g_16",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3801")
    def test_mstathpt_open_vlan_tcp_ul_5g_16(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_17",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3803")
    def test_mstathpt_open_vlan_udp_ul_5g_17(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_18",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3805")
    def test_mstathpt_open_vlan_tcp_dl_5g_18(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_19",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3807")
    def test_mstathpt_open_vlan_udp_ul_5g_19(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_ul_5g_20",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3811")
    def test_mstathpt_open_vlan_tcp_ul_5g_20(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_dl_5g_21",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3813")
    def test_mstathpt_open_vlan_udp_dl_5g_21(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_dl_5g_22",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3816")
    def test_mstathpt_open_vlan_tcp_dl_5g_22(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_udp_ul_5g_23",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3818")
    def test_mstathpt_open_vlan_udp_ul_5g_23(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
    ...
    @pytest.mark.open
    @pytest.mark.fiveg
    @allure.testcase(name="test_mstathpt_open_vlan_tcp_ul_5g_24",
                     url="https://telecominfraproject.atlassian.net/browse/WIFI-3820")
    def test_mstathpt_open_vlan_tcp_ul_5g_24(self, get_vif_state, lf_tools,
                                create_lanforge_chamberview_dut, lf_test, get_configuration):
        """
        pytest -m "Multi_Sta_Thpt and vlan and open and fiveg"
